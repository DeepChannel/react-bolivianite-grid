...
export declare type HeaderResizeBehavior = 'auto' | 'manual' | 'reset';
export declare type HeaderFilter = (props: {
    header: IHeader;
    type: HeaderType;
}) => boolean;
export declare type HeaderClampFunction = (props: {
    header: IHeader;
    type: HeaderType;
    size: number;
}) => number;
...
export declare type TGridReadOnlyEventSource = 'editor' | 'paste' | 'nullify';
